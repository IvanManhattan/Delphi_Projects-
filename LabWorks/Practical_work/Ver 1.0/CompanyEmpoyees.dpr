...
begin
  ...
  currentCandidate := listOfCandidates;
  currentCompany := listOfCompanies;
  ...
  begin
    while currentCandidate <> nil do
    begin
      if currentCompany^.nameOfSpeciality = currentCandidate^.speciality then
      begin
        hasCandidates := true;
      end
      else
      ...
      begin
        currentDeficitSpeciality^.deficitSpeciality := currentCompany^.nameOfSpeciality;
        currentDeficitSpeciality^.deficitCompany := currentCompany^.nameOfCompany;
        currentDeficitSpeciality := currentDeficitSpeciality^.next;
      end;
